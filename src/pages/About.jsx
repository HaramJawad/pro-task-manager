        ...
        <div className="about-page">
            <div className="about-header">
                ...
                <p className="about-subtext">
                    A clean, focused task management app built with React. 
                    Designed to help you stay organised, track priorities, and get things done.
                </p>
            </div>
            ...
            <div className="about-grid">
                ...
                <section className="about-card features-card">
                    ...
                    <ul className="features-list">
                        ...
                        <li><span className="icon-box">📱</span> Fully responsive design</li>
                    </ul>
                </section>
            ...
            <footer className="about-footer">
                <p>TaskFlow © 2026 · Built with ❤️ by Haram Jawad</p>
            </footer>
        </div>
    );
}
